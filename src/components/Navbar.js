...
export default function Navbar(props) {
  return (
    ...
    <div className="container-fluid" >
      <a className="navbar-brand" htmlFor="/">{props.title}</a>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <a className="nav-link active" aria-current="page" htmlFor="/">Home</a>
          </li>
          ...
          <li className="nav-item">
            <a className="nav-link" htmlFor="/about">{props.aboutText}</a>
          </li>
        </ul>
...
Navbar.propTypes = {
  title : PropTypes.string,  // We can set "PropTypes.string.isRequired" to make it necessary to input
  aboutText : PropTypes.string
}
// Default props should be meaningful
Navbar.defaultProps = {
  title : "Title Here", 
